...
namespace MorseServer.Classes
{
	public class HD44780Controller
	{
        ...
        public void Init(int rs, int rw, int enable, int d0, int d1, int d2, int d3, int d4, int d5, int d6, int d7)
		...
		public void SetCursorPosition(int row, int column)
		{
			...
			BitArray pos = new BitArray(new int[] { ((32 * row) + column) });
